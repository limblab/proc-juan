...
function can_corrs = get_canon_corr( single_trial_data, signals, dims, varargin )
    ...
    switch target
        case 'all_conc'
            switch signals
                ...
                case 'neurons'
                    scores_1 = single_trial_data{comb_bdfs(p,1)}.target{end}.neural_data.conc_smoothed_fr(:,dims);
                    scores_2 = single_trial_data{comb_bdfs(p,2)}.target{end}.neural_data.conc_smoothed_fr(:,dims);
                case 'emgs'
                    scores_1 = single_trial_data{comb_bdfs(p,1)}.target{end}.emg_data.conc_emg(:,dims);
                    scores_2 = single_trial_data{comb_bdfs(p,2)}.target{end}.emg_data.conc_emg(:,dims);
            end
        otherwise
            switch signals 
                case 'scores'
                ...
                case 'neurons'
                    scores_1 = single_trial_data{comb_bdfs(p,1)}.target{target}.neural_data.conc_smoothed_fr(:,dims);
                    scores_2 = single_trial_data{comb_bdfs(p,2)}.target{target}.neural_data.conc_smoothed_fr(:,dims);
                case 'emgs'
                    scores_1 = single_trial_data{comb_bdfs(p,1)}.target{target}.emg_data.conc_emg(:,dims);
                    scores_2 = single_trial_data{comb_bdfs(p,2)}.target{target}.emg_data.conc_emg(:,dims);
            end
    end
